...
public class CommandManager {
    ...
    private AbstractCommand sumOfImpactSpeed;
    ...
    public CommandManager(AbstractCommand helpCommand, AbstractCommand infoCommand, AbstractCommand showCommand, AbstractCommand insertCommand, AbstractCommand updateCommand, AbstractCommand removeKeyCommand, AbstractCommand clearCommand, AbstractCommand executeScriptCommand, AbstractCommand exitCommand, AbstractCommand historyCommand, AbstractCommand removeLowerKeyCommand, AbstractCommand sumOfImpactSpeed, AbstractCommand signUpCommand, AbstractCommand signInCommand, AbstractCommand logOutCommand) {
        ...
        this.sumOfImpactSpeed = sumOfImpactSpeed;
        commands.add(sumOfImpactSpeed);
     ...
     * @return Command exit status.
     */
    public boolean sumOfImpactSpeed(String argument, Object objectArgument, User user) {
        locker.lock();
        try {
            return sumOfImpactSpeed.execute(argument, objectArgument, user);
        } finally {
            locker.unlock();
        }
    }
