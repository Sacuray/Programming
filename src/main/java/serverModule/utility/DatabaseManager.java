...
public class DatabaseManager {
    public static final String HUMAN_TABLE = "human_being";
    ...
    public static final String HUMAN_TABLE_KEY_COLUMN = "key";
    public static final String HUMAN_TABLE_NAME_COLUMN = "name";
    public static final String HUMAN_TABLE_COORDINATES_ID_COLUMN = "coordinates_id";
    public static final String HUMAN_TABLE_CREATION_DATE_COLUMN = "creation_date";
    public static final String HUMAN_TABLE_REAL_HERO_COLUMN = "real_hero";
    public static final String HUMAN_TABLE_HAS_TOOTHPICK_COLUMN = "has_toothpick";
    public static final String HUMAN_TABLE_IMPACT_SPEED_COLUMN = "impact_speed";
    public static final String HUMAN_TABLE_WEAPON_TYPE_COLUMN = "weapon_type";
    public static final String HUMAN_TABLE_MOOD_COLUMN = "mood";
    public static final String HUMAN_TABLE_CAR_ID_COLUMN = "car_id";
    public static final String HUMAN_TABLE_USER_ID_COLUMN = "user_id";
    ...
    public static final String CAR_TABLE_ID_COLUMN = "id";
    public static final String CAR_TABLE_NAME_COLUMN = "name";
